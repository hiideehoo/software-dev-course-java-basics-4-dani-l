...
public class CollectionExercises {
    ...
    public ArrayList<String> makeListOfThreeFruits(String fruit1, String fruit2, String fruit3) {
        ...
        ArrayList<String> fruitListOfThree = new ArrayList<String>();
        fruitListOfThree.add(fruit1);
        fruitListOfThree.add(fruit2);
        fruitListOfThree.add(fruit3);

        return fruitListOfThree;
    }
